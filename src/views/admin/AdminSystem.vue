<template>
    <el-table :data="state.sitchList" style="width: 100%" empty-text="暂无数据" stripe border>
        <el-table-column prop="configName" label="开关名称" width="100" />
        ...
        <el-table-column fixed="right" label="操作">
            <template #default="scope">
                <el-switch v-model="scope.row.statu" style="margin-left: 24px" inline-prompt :active-icon="Check"
                    :inactive-icon="Close" active-value="0" inactive-value="1"
